...
public class CmSubNetNe extends BaseVO {
	...
	/**
	 * 名称：网元rmUID 最大长度: 是否必填：是 取值范围及说明： 数据示例：
	 * */
	String rmUID;
	...
	/**
	 * 名称：所属子网rmUID 最大长度: 是否必填：是 取值范围及说明： 数据示例：
	 * */
	String subnetrmUID;
	/**
	 * 名称：相对X坐标 最大长度: 是否必填：是 取值范围及说明：网元在子网拓扑图中的X坐标 数据示例1：99 数据示例2：99
	 * */
	String xPos;
	/**
	 * 名称：相对Y坐标 最大长度: 是否必填：是 取值范围及说明：网元在子网拓扑图中的Y坐标 数据示例1：233 数据示例2：233
	 * */
	String yPos;
