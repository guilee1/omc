...
public class CmTunnelPGInfo extends BaseVO {
	...
	/**
	 * 名称：本地名称 最大长度:255 是否必填：是 取值范围及说明：OMC上的隧道保护组名称
	 * 数据示例：9001-WHCQ-L3-PTN6900-1-9007-WHDCY-L2L3-3-PG-00000001
	 * */
	String nativeName;
	/**
	 * 名称：保护组恢复方式 最大长度: 是否必填：是 取值范围及说明：枚举值包括： RM_REVERTIVE：恢复式；
	 * RM_NON_REVERTIVE：非恢复式； RM_UNKNOWN：未知。 数据示例：RM_REVERTIVE
	 * */
	String reversionMode;
	/**
	 * 名称：保护类型 最大长度: 是否必填：是 取值范围及说明：枚举值包括：1+1、1:1。 数据示例：1+1
	 * */
	String type;
