...
public class CmNE extends BaseVO {
	...
	/**
	 * 名称：本地名称 最大长度:255 是否必填：是 取值范围及说明OMC上显示的网元名称 在所属OMC范围内唯一：
	 * 数据示例:3519-马鞍山西塘路２楼测试－PTN960
	 * */
	String nativeName;
	/**
	 * 名称：物理位置 最大长度:255 是否必填：否 取值范围及说明：OMC上设置的网元放置位置，建议在OMC上设置到地市级 数据示例:
	 * */
	String location = "";
	/**
	 * 名称：设备型号 最大长度:50 是否必填：是 取值范围及说明： 数据示例:OptiX PTN 960
	 * */
	String productName;
	/**
	 * 名称：设备供应商 最大长度:20 是否必填：是 取值范围及说明：见《OMC系统北向接口数据规范-公共数据分册》 数据示例:
	 * */
	String vendor;
	/**
	 * 名称：虚实性 最大长度:20 是否必填：是 取值范围及说明：描述网元是OMC上管理的实际网元还是在OMC上虚拟的相邻OMC上的网元
	 * 枚举值包括：real：实际网元；virtual：虚拟网元 数据示例:real
	 * */
	String reality;
	/**
	 * 名称：设备IP 最大长度:40 是否必填：是 取值范围及说明： 数据示例:129.9.5.106
	 * */
	String IPAddress;
	/**
	 * 名称：控制平面IP地址 最大长度:40 是否必填：否 取值范围及说明： 数据示例:129.9.5.106
	 * */
	String controlPlaneIP = "";
	/**
	 * 名称：硬件版本 最大长度:255 是否必填：否 取值范围及说明：有则必填 数据示例:
	 * */
	String hardwareVersion = "";
	/**
	 * 名称：软件版本 最大长度:255 是否必填：是 取值范围及说明： 数据示例:V100R003C03SPC200
	 * */
	String softwareVersion;
	/**
	 * 名称：设备支持的最大配置能力 最大长度: 是否必填：否 取值范围及说明：设备的最大交换容量 数据示例:80G
	 * */
	String maxCapacity = "";
	/**
	 * 名称：状态 最大长度: 是否必填：是 取值范围及说明：枚举值包括： avaliable：可用；unavaliable：不可用
	 * 数据示例:avaliable
	 * */
	String state;
	...
	public void setHardwareVersion(String hardwareVersion) {
		if (StringUtils.isNotEmpty(hardwareVersion) && hardwareVersion.length() > 255)
