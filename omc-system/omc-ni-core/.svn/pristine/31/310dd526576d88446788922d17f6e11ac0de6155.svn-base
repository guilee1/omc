...
// 生成时间: 2017.08.12 时间 09:45:18 AM CST 
//
...
public class DataFile {
    ...
    protected List<DataFile.Objects> objects;
     ...
     * 
     */
    public List<DataFile.Objects> getObjects() {
        if (objects == null) {
            objects = new ArrayList<DataFile.Objects>();
        }
        return this.objects;
    }
