...
public class CmCard extends BaseVO {
	...
	String nermUID;
	/**
	 * 名称：所属容器rmUID 最大长度: 是否必填是 取值范围及说明: 数据示例:
	 */
	String holderrmUID;
	/**
	 * 名称：本地名称 最大长度:255 是否必填：否 取值范围及说明： OMC上显示的板卡名称 数据示例:D1EM8F
	 */
	String nativeName = "";
	/**
	 * 名称：板卡型号 最大长度:255 是否必填否 取值范围及说明： 数据示例:D1EM8F
	 */
	String cardType;
	/**
	 * 名称：板卡子类型 最大长度:50 是否必填否 取值范围及说明： 有则必填 数据示例:
	 */
	String cardSubType = "";
	/**
	 * 名称：软件版本 最大长度:255 是否必填是 取值范围及说明： 数据示例:V1R2C00
	 */
	String softwareVersion;
	/**
	 * 名称：硬件版本 最大长度:255 是否必填是 取值范围及说明 数据示例:
	 */
	String hardwareVersion;
	/**
	 * 名称：序列号 最大长度:255 是否必填否 取值范围及说明： 有则必填；如果单板没有序列号但有条形码时，该属性填报条形码信息
	 * 数据示例:020PRR10AB000071
	 */
	String serialNumber = "";
	/**
	 * 名称：单板状态 最大长度: 是否必填是 取值范围及说明 ：枚举值包括： IN_SERVICE：单板处于正常工作状态；
	 * OUT_OF_SERVICE：单板无法正常工作；
	 * OUT_OF_SERVICE_BY_MAINTENANCE：单板由于维护性操作无法正常工作。例如更换单板等； SERV_NA：单板状态无法获知
	 * 数据示例:IN_SERVICE
	 */
	String serviceState;
	/**
	 * 名称：板卡角色 最大长度: 是否必填是 取值范围及说明 ：枚举值包括： Master：主用； Backup：备用； NA：无主备板卡
	 * 数据示例:Master
	 */
	String role;
