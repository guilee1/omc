...
public class CmTunnel extends BaseVO {
	...
	/**
	 * 名称：本地名称 最大长度:255 是否必填是 取值范围及说明 :OMC上显示的隧道名称
	 * 数据示例:2014-武汉冷冻六厂/39-9005-武汉东菜园L2/L3-静态CR-65P
	 */
	String nativeName;
	/**
	 * 名称：方向 最大长度: 是否必填是 取值范围及说明 :标识隧道是单向还是双向 枚举值包括： CD_UNI：单向；CD_BI：双向
	...
	String activeState;
	/**
	 * 名称：源端rmUID 最大长度: 是否必填否 取值范围及说明 :当源端是双向时必填 数据示例:
	 */
	String aEndTprmUID = "";
	/**
	...
	String aEndNermUID;
	/**
	 * 名称：源端端口rmUID 最大长度: 是否必填否 取值范围及说明 :当源端端口是双向时必填 数据示例:
	 */
	String aEndPortrmUID = "";
	/**
	 * 名称：源端出标签 最大长度:20 是否必填否 取值范围及说明 : 数据示例:17
	 */
	String aEndOutLabel = "";
	/**
	 * 名称：源端入标签 最大长度:20 是否必填否 取值范围及说明 : 数据示例:148
	 */
	String aEndRevInLabel = "";
	/**
	 * 名称：宿端rmUID 最大长度: 是否必填否 取值范围及说明 :当宿端是双向时必填 数据示例:
	 */
	String zEndTprmUID = "";
	/**
	...
	String zEndNermUID;
	/**
	 * 名称：宿端端口rmUID 最大长度: 是否必填否 取值范围及说明 :当宿端端口是双向时必填 数据示例:
	 */
	String zEndPortrmUID = "";
	/**
	 * 名称：宿端入标签 最大长度:20 是否必填否 取值范围及说明 : 数据示例:32
	 */
	String zEndInLabel = "";
	/**
	 * 名称：宿端出标签 最大长度:20 是否必填否 取值范围及说明 : 数据示例:36
	 */
	String zEndRevOutLabel = "";
	/**
	 * 名称：CIR 最大长度:20 是否必填否 取值范围及说明 :有则必填，单位：kbit/s 数据示例:
	 */
	String CIR = "";
        /**
         * 名称：RevCIR 最大长度:20 是否必填否 取值范围及说明 :有则必填，单位：kbit/s 数据示例:
         */
        String RevCIR = "";
	/**
	 * 名称：PIR 最大长度:20 是否必填否 取值范围及说明 :有则必填，单位：kbit/s 数据示例:
	 */
	String PIR = "";
        /**
         * 名称：RevPIR 最大长度:20 是否必填否 取值范围及说明 :有则必填，单位：kbit/s 数据示例:
         */
        String RevPIR = "";
	/**
	 * 名称：是否overlay 最大长度: 是否必填是 取值范围及说明 :标识隧道是否是overlay方式 枚举值包括：
	...
	public void setCIR(String cIR) {
        ...
        public void setRevCIR(String revCIR){
            if(StringUtils.isEmpty(revCIR)){
                revCIR = "";
            }
            if(revCIR.length() > 20){
                Asserter.fail(this.getClass(), "revCIR");
                RevCIR = revCIR;
            }
        }
	...
	public void setPIR(String pIR) {
        ...
        public void setRevPIR(String revPIR){
            if(StringUtils.isEmpty(revPIR)){
                revPIR = "";
            }
            if(revPIR.length() > 20){
                Asserter.fail(this.getClass(), "revPIR");
                RevPIR = revPIR;
            }
        }
