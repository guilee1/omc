...
public interface IResInf {
	 ...
	 * @return CmPort
	 */
	List<CmPort> getEthPort();
	/**
	 * 获取端口
	 * @return CmPort
	 */
	List<CmPort> getPdhPort();
	/**
	 * 获取端口
	 * @return CmPort
	 */
	List<CmPort> getSubPort();
	/**
	 * 获取端口
	 * @return CmPort
	 */
	List<CmPort> getOtherPort();
	/**
	 * 获取端口绑定
	 ...
	 * @return
	 */
	List<CmEProtectGroup> getCmEProtectGroup();
	
	/**
	 * 获取板卡保护组单元
	 * @return
	 */
	List<CmEProtectGroupUnit> getCmEProtectGroupUnit();
	
	/**
	 * 获取端口保护组
	 * @return
	 */
	List<CmProtectGroup> getCmProtectGroup();
	 ...
	 * @return
	 */
	List<CmProtectGroupUnit> getCmProtectGroupUnit();
}
