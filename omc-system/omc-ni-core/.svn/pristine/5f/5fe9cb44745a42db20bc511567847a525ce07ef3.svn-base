...
public class CmSubNet extends BaseVO {
	...
	/**
	 * 名称：本地名称 最大长度:255 是否必填：是 取值范围及说明：OMC上显示的子网名称 在OMC下唯一 数据示例1：Subnet-165
	 * 数据示例2：Subnet-165
	 * */
	String nativeName;

	/**
	 * 名称：所属上级子网rmUID 最大长度: 是否必填：否 取值范围及说明：1、有则必填 数据示例：
	 * */
	String parentSubnetrmUID = "";
	/**
	 * 名称：相对X坐标 最大长度: 是否必填：是 取值范围及说明：该子网在其所属上级子网拓扑图中的X坐标 数据示例1：100 数据示例2：100
	 * */
	String xPos;
	/**
	 * 名称：相对Y坐标 最大长度: 是否必填：是 取值范围及说明：该子网在其所属上级子网拓扑图中的Y坐标 数据示例1：200 数据示例2：200
	 * */
	String yPos;
